...
namespace Ailments
{
    public class BlockBehaviorTemporalHarvestable : BlockBehavior
    {
        float harvestTime;
        public BlockDropItemStack harvestedStack;
        SystemTemporalStability stormWatcher;
        ...
        public BlockBehaviorTemporalHarvestable(Block block) : base(block)
        {
        }
        ...
        public override bool OnBlockInteractStart(IWorldAccessor world, IPlayer byPlayer, BlockSelection blockSel, ref EnumHandling handling)
        {
            ...
            if (stormWatcher == null) stormWatcher = byPlayer.Entity.Api.ModLoader.GetModSystem<SystemTemporalStability>();

            if (stormWatcher == null || !stormWatcher.StormData.nowStormActive)
            {
        ...
        {
            if (harvestedStack != null && stormWatcher != null || stormWatcher.StormData.nowStormActive)
            {
