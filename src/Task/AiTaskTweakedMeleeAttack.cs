...
namespace Ailments
{
    public class AiTaskTweakedMeleeAttack : AiTaskBase, IWorldIntersectionSupplier
    {
        Entity targetEntity;
        ...
        public AiTaskTweakedMeleeAttack(EntityAgent entity) : base(entity)
        {
        }
        ...
        public override bool ContinueExecute(float dt)
        {
            ...
            if (!damageInflicted)
            {
                ...
                float mechdmg = 1f;
                if (targetEntity.Properties.Attributes.IsTrue("isMechanical"))
                {
                    mechdmg = entity.Stats.GetBlended("mechanicalsDamage");
                }
                ...
                ((EntityAgent)targetEntity).ReceiveDamage(
                    ...
                    damage * GlobalConstants.CreatureDamageModifier * entity.Stats.GetBlended("meleeWeaponsDamage") * mechdmg
                );
